    ...
    xdg.configFile."niri/config.kdl".text =
      ...
      ''
        ...
        binds {
            ...
            Mod+Ctrl+1 { move-column-to-workspace "${ws_web}"; }
            Mod+Ctrl+2 { move-column-to-workspace "${ws_term}"; }
            Mod+Ctrl+3 { move-column-to-workspace "${ws_code}"; }
            Mod+Ctrl+0 { move-column-to-workspace "${ws_perso}"; }
