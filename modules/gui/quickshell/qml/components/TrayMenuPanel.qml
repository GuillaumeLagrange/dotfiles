...
//
// A row with children is entered rather than flown out sideways: a flyout has
// to be reached by crossing the rows between it and the pointer, and any one
// of them takes the hover and closes it.
import QtQuick
