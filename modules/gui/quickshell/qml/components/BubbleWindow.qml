...
//
// A popup window, which is all a tooltip needs: nothing in it is hovered into
// or clicked. Panels are layer surfaces (PopupPanel, ClickPanel) instead, which
// is what lets them hold focus and cover the screen.
//
