// UPower-backed battery badge: no sysfs polling. Hidden outright on desktops
// with no laptop battery. Quick settings reads UPower.displayDevice directly
// for its own panel rather than through this pill.
