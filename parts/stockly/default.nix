{
  flake.modules.homeManager.stockly =
    {
      pkgs,
      lib,
      config,
    ...
    in
    {
      options.stockly.enable = lib.mkEnableOption "stockly specific tools";
      ...
      config = lib.mkIf config.stockly.enable {
        ...
        home.packages = [
          ...
          (pkgs.callPackage ./_insomnia.nix { })
          (pkgs.callPackage ./_monster.nix {
