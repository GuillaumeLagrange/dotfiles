...
# Which Home-Manager configuration to apply.
# TODO: make this username-agnostic (currently relies on the committed entry).
HM_CONFIG="guillaume"
...
nix run \
  ...
  switch --flake "${REPO_ROOT}#${HM_CONFIG}" -b backup
